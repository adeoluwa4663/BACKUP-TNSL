    ...
    <div className="term">
      ...
      <ul className="terms-list">
        <li className="terms-list-li">
          <b>Terms:</b> By accessing the website www.thenextstagelab.com, you
        ...
        <br />
        <li>
          <b>Use of license:</b> Permission is not granted to download one copy
          of the materials (information or software) on TNSL's website for
        ...
        <p>
          ...
          restrictions and may be terminated by TNSL at any time. Upon
        ...
        <br />
        <li>
          <b>Disclaimer:</b> The materials on TNSL's website are provided on an
          'as is' basis. TNSL makes no warranties, expressed or implied, and
          hereby disclaims and negates all other warranties including, without
          limitation, implied warranties or conditions of merchantability,
          fitness for a particular purpose, or non-infringement of intellectual
          property or other violation of rights.
          <br />
          Further, TNSL does not warrant or make any representations concerning
        ...
        <br />
        <li>
          <b>Limitations:</b> In no event shall TNSL or its suppliers be liable
          ...
          use or inability to use the materials on TNSL's website, even if TNSL
          or a TNSL authorized representative has been notified orally or in
        ...
        <br />
        <li>
          <b>Accuracy of materials:</b> The materials appearing on TNSL's
          website could include technical, typographical, or photographic
          errors. TNSL does not warrant that any of the materials on its website
          are accurate, complete or current. TNSL may make changes to the
          materials contained on its website at any time without notice.
          However, TNSL does not make any commitment to update the materials.
        </li>
        <br />
        <li>
          <b>Links:</b> TNSL has not reviewed all of the sites linked to its
          website and is not responsible for the contents of any such linked
          site. The inclusion of any link does not imply endorsement by TNSL of
          the site. Use of any such linked website is at the user's own risk.
        </li>
        <br />
        <li>
          <b>Modifications:</b> TNSL may revise these terms of service for its
        ...
        <br />
        <li>
          <b>Governing Laws:</b> These terms and conditions are governed by and
          construed in accordance with the laws of Lagos, Nigeria and you
