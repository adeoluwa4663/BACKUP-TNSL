    ...
    <div className="Top">
      ...
      <div className="policy-p">
        <p>
          ...
          <br />
          It is TNSL's policy to respect your privacy regarding any information
          we may collect while operating our website. Accordingly, we have
      ...
      <div>
        <p>
          ...
          information is protected and maintained. TNSL may change this privacy
          policy from time to time at TNSL's sole discretion.
        </p>
      </div>
    </div>
  );
